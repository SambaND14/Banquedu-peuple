   ...
   <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#!"><i class="fa fa-database" aria-hidden="true"></i>ACCUEIL</a>
        </div>
        <div id="navbar" class="collapse navbar-collapse">
          ...
          <div  class="container">
            ...
            <p style="text-align: center; color: #004d99 !important;">BIENVENUE DANS L'ESPACE DE GESTIONS DES MEMBRES</p>
             <hr>
             ...
             <div class="col-sm-12 col-sm-offset-0">
              ...
              <div  style="border: solid 1px #004d99;"  class="panel panel-default">
                <div  style="border: solid 1px #004d99 ;"  class="panel-heading ">
                 <h4 style="text-align: center;"><i style="color:#004d99" class="fa fa-tachometer fa-2x" aria-hidden="true"></i>
 MENU DU SYSTEME</h4>
               </div>
                <hr>
        ...
        <div  class="container">
          ...
          <div class="col-sm-10 col-sm-offset-1">
            ...
            <div  class="container1">
                ...
                <i class="material-icons" style="font-size: 50px">person_add</i></h1><br>
               <span>AJOUTER</span>
              </a>
              <a href="supp.php"><h1>
               <i class="material-icons" style="font-size: 50px">delete_forever</i></h1><br>
               <span>SUPPRIMER</span>
             </a>
             <a href="mod.php"><h1>
               <i class="material-icons" style="font-size: 50px">account_circle</i></h1><br>
               <span >MODIFIER</span>
             </a>
             <a href="liste.php"><h1>
               <i class="material-icons" style="font-size: 50px">assignment</i></h1><br>
               <span>LISTER</span>
             </a>   
             <a href="comp.php"><h1>
               <i class="material-icons" style="font-size: 50px">monetization_on</i></h1><br>
