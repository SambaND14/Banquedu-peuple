   ...
   <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#!"><i class="fa fa-database" aria-hidden="true"></i>  MODIFIER</a>
        </div>
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav navbar-right">
                        <li style="padding-top: 10px;">
              <form action="search.php" method="GET" enctype="multipart/form-data">
                   <input style="border: solid 1px #001a33; border-radius: 3em; width: 500px; height: 30px;" type="search" name="supprimer" placeholder="search">
...
<div  class="container">
  <p style="text-align: center; color: #004d99 !important;"><a style="color: #004d99 ; float: left;" href="index.php"><i class="fa fa-arrow-left" aria-hidden="true"></i><i class="material-icons" style="font-size: 50px">home</i></a> MODIFIER UN MEMBRE  
  ...
  <div class="bcg" class="container">
            ...
            <div class="col-sm-4 col-sm-offset-4">
                ...
                <p style="color:#004d99; text-align: center;"  >Groupeisi.snl &copy; 2019, All Rights Reserved</p>
