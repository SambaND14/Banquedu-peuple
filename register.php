  ...
  <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#!"><i class="fa fa-database" aria-hidden="true"></i> WIND UNIX   > login > register</a>
        </div>
...
<div class="col-sm-4 col-sm-offset-4">
       ...
       <?php  include('includes/_alert.php');?>
              <form data-parsley-validate method="post" action="" class="well">
                ...
                <div class="form-group">
                  <input type="solde"  class="form-control" name="solde" required=""/>
                </div>
...
$solde  = $_POST['solde'];
  ...
  echo
   $insert = " INSERT INTO admin (nom, email, numero, titre, pseudo, solde) VALUES('$nom','$email','$numero','$titre','$pseudo','$solde')";
