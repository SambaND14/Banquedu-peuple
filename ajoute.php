...
<html lang="fr">
  ...
  <body style="background-image:url(images/14.jpg);
   ...
   <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#!"><i class="fa fa-database" aria-hidden="true"></i>  <?php $a = " AJOUTER MEMBRE"; echo " $a ";?></a>
        </div>
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav navbar-right">
                        <li style="padding-top: 10px;">
             <form action="search.php" method="GET" enctype="multipart/form-data">
                   <input style="border: solid 1px #004d99; border-radius: 3em; width: 500px; height: 30px;" type="search" name="supprimer" placeholder="search">
...
<div  class="container">
  <p style="text-align: center; color: #004d99 !important;"><img src="images/123.jpg " alt="user1" width="200px"></h1><br></p>
  <hr>
...
<div class="col-sm-11 col-sm-offset-0">
                ...
                <div  style="border: solid 1px #004d99 ;"  class="panel-heading ">
                 <h5 style="text-align: center;"><a style="float: left; color: white; font-size: 15px;" href="index.php"><i class="fa fa-arrow-left" aria-hidden="true"></i><a href="index.php"><h1>
                <i class="material-icons" style="font-size: 20px">home</i></h1><br>
              </a></a> Ajouter un membre ici <i class="fa fa-plus-circle" aria-hidden="true"></i><br></h5>
               </div>
                <hr>
                 <div id="main-content">
             ...
             <div class="row">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <input type="text" placeholder="prenom..." name="prenom" id="prenom" value="" class="form-control" required="required">
                </div>
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <label class="control-label" for="solde" >solde<span class="text-danger"></span></label>
                    <input type="solde"  name="solde" id="solde" value="" class="form-control" placeholder="solde" />
  ...
  <div class="bcg" class="container">
            ...
            <div class="col-sm-4 col-sm-offset-4">
                ...
                <p style="color:#004d99; text-align: center;"  >Groupeisi.sn &copy; 2019, All Rights Reserved</p>
                <marquee direction="left">
                <p style="color:#004d99; text-align: center;"  > CE SITE A ETE CONSU PAR SAMBA NDIAYE L3 LPGL . </p></marquee>
            </div>
...
if (isset($_POST['registeruser'])) {
  ...
  echo
   $insert = " INSERT INTO users (nom, prenom, quartier,avatar, sex, numero, email, matricule, solde) VALUES('$nom','$prenom','$quartier','$avatar','$sex','$numero','$email','$matricule','$solde')";
