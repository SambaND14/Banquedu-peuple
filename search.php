   ...
   <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#!"><i class="fa fa-database" aria-hidden="true"></i>Recherche</a>
        </div>
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav navbar-right">
              ...
              <form action="search.php" method="GET" enctype="multipart/form-data">
                   ...
                   <button style="background-color: #001a33; color: white; width: 30px; height: 30px; border: solid 0.5px #001a33; border-radius: 100%;" type="submit" name="search" value="search"></button>
              </form> 
            </li>
...
<div  class="container">
  <p style="text-align: center; color: #004d99 !important;">search for members</p>
  <hr>
...
<div class="col-sm-11 col-sm-offset-0">
      ...
      $get_m = "SELECT * FROM users WHERE matricule LIKE '%$requete_user%'";
