   ...
   <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#!"><i class="fa fa-database" aria-hidden="true"></i>   PROFIL</a>
        </div>
...
<div  class="container">
  <p style="text-align: center; color: #004d99 !important;">PROFIL
...
<div class="col-sm-11 col-sm-offset-0">
                ...
                <div  style="border: solid 1px #004d99 ;"  class="panel-heading ">
                 <h4 style="text-align: center;"><a style="float: left; color: white; font-size: 15px;" href="liste.php"><i class="fa fa-arrow-left" aria-hidden="true"></i><i class="material-icons" style="font-size: 20px">home</i></a></h4><br></h1>
               </div>
                <hr>
        <div id="main-content">
